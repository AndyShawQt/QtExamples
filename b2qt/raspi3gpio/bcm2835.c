...
volatile unsigned int *bcm2835_gpio = MAP_FAILED;
volatile unsigned int *bcm2835_pwm  = MAP_FAILED;
volatile unsigned int *bcm2835_clk  = MAP_FAILED;
volatile unsigned int *bcm2835_pads = MAP_FAILED;
volatile unsigned int *bcm2835_spi0 = MAP_FAILED;
volatile unsigned int *bcm2835_bsc0 = MAP_FAILED;
volatile unsigned int *bcm2835_bsc1 = MAP_FAILED;
volatile unsigned int *bcm2835_st	= MAP_FAILED;
